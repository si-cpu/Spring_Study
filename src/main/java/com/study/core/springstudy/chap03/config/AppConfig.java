package com.study.core.springstudy.chap03.config;

import com.study.core.chap03.*;
import com.study.core.springstudy.chap03.*;
import com.study.springstudy.core.chap03.*;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

// 스프링에게 객체 생성 등의 제어를 맡길 떄 사용하는 어노테이션,
...
public class AppConfig {
    ...
    // 쉐프 객체 생성
    @Bean // 메서드에서 특정 객체가 생성되어 리턴될 떄, 객체의 생명 주기를 Spring이 관리하도록 설정.
    public Chef chef1(){
        return new KimChef();
    }
    @Bean
