...
/*@RequiredArgsConstructor --> final필드를 초기화하는 생성자.*/
@Getter@ToString
// @Setter -> Setter는 일부러 구현하지 않는 것을 한다. 더이상의 변경은 없다는 뜻이다.
public class ScoreResponseDTO {
    ...
    *
    ...
    private String makeMaskingName(String stuName) {
        ...
        StringBuilder maskedName = new StringBuilder(String.valueOf(stuName.charAt(0))); // 성만 추출

        // 성 빼고 나머지 이름의 길이 만큼 반복해서 *을 붙이자.
